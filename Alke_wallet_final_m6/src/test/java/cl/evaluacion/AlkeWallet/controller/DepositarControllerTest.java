...
/**
 * Pruebas unitarias para DepositarController.
 */
public class DepositarControllerTest {
    ...
    /**
     * Prueba para verificar la carga exitosa de la página de depósito ("/depositar").
     */
    @DisplayName("Prueba de carga de página de depósito exitosa")
    @Test
    ...
    /**
     * Prueba para verificar el comportamiento exitoso de la acción de depósito.
     */
    @DisplayName("Prueba de depósito exitoso")
    @Test
    ...
    /**
     * Prueba para verificar el comportamiento en caso de error durante la acción de depósito.
     */
    @DisplayName("Prueba de error en depósito")
    @Test
